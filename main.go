...
func main() {
	...
	scheduleSvc := schedule.New(schedule.Deps{
		...
		FederateScheduledEventUpdate:     apSvc.SendScheduledEventUpdate,
		FederateScheduledEventDelete:     apSvc.SendScheduledEventDelete,
		FederateScheduledEventReminder:   apSvc.SendScheduledEventReminder,
