...
func (s *Service) CreateCreateActivity(id string, localAccountIRI *url.URL) vocab.ActivityStreamsCreate {
	objectID := s.MakeLocalIRIForResource(id)
	message := s.MakeCreateActivity(objectID)
...
func (s *Service) AddImageAttachmentToNote(note vocab.ActivityStreamsNote, image, mediaType string) {
