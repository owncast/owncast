...
func (s *Service) MakeWebfingerResponse(account string, inbox string, host string) WebfingerResponse {
	accountIRI := s.MakeLocalIRIForAccount(account)
...
// to use model.
func (s *Service) MakeWebFingerRequestResponseFromData(data []map[string]interface{}) WebfingerProfileRequestResponse {
