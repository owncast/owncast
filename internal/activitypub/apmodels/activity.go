...
func (s *Service) MakeNotePublic(note vocab.ActivityStreamsNote) vocab.ActivityStreamsNote {
...
// direct message.
func (s *Service) MakeNoteDirect(note vocab.ActivityStreamsNote, toIRI *url.URL) vocab.ActivityStreamsNote {
...
// as a direct message.
func (s *Service) MakeActivityDirect(activity vocab.ActivityStreamsCreate, toIRI *url.URL) vocab.ActivityStreamsCreate {
	to := streams.NewActivityStreamsCcProperty()
	to.AppendIRI(toIRI)
	to.AppendIRI(toIRI)
...
// seen as public.
func (s *Service) MakeActivityPublic(activity vocab.ActivityStreamsCreate) vocab.ActivityStreamsCreate {
	// TO the public if we're not treating ActivityPub as "private".
	if !s.data.GetFederationIsPrivate() {
		public, _ := url.Parse(PUBLIC)
...
func (s *Service) MakeCreateActivity(activityID *url.URL) vocab.ActivityStreamsCreate {
...
func (s *Service) MakeUpdateActivity(activityID *url.URL) vocab.ActivityStreamsUpdate {
...
func (s *Service) MakeNote(text string, noteIRI *url.URL, attributedToIRI *url.URL) vocab.ActivityStreamsNote {
