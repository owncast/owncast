...
export const Noscript: FC = () => (
  <noscript className={styles.noscript}>
    <div className={styles.content}>
      ...
      <p>
        For the best experience, you should use a different browser with JavaScript support. If you
        have disabled JavaScript in your browser, you can re-enable it.
      </p>
