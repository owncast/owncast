...
OnlineStream.args = {
  ...
  serverLogo: 'https://picsum.photos/64/64?random=1',
...
OfflineStream.args = {
  ...
  serverLogo: 'https://picsum.photos/64/64?random=3',
...
OnlineWithoutThumbnail.args = {
  ...
  serverLogo: 'https://picsum.photos/64/64?random=4',
...
LongContent.args = {
  ...
  serverLogo: 'https://picsum.photos/64/64?random=5',
  streamTitle:
