    ...
    <Spin spinning={loading}>
      <Space direction="vertical">
        ...
        <Collapse ghost>
          ...
          >
            <p>You can link your chat identity with your Fediverse identity. Next time you want to use this chat identity you can again go through the Fediverse authentication.</p>
          </Panel>
        </Collapse>
        <div>
