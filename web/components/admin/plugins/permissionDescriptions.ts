...
export const permissionDescriptionKey: Record<string, string> = {
  ...
  [PluginPermission.StorageSQL]: Localization.Admin.Plugins.Permissions.storageSql,
  ...
  [PluginPermission.FediverseInbound]: Localization.Admin.Plugins.Permissions.fediverseInbound,
...
export const permissionNameKey: Record<string, string> = {
  ...
  [PluginPermission.StorageSQL]: Localization.Admin.Plugins.PermissionNames.storageSql,
  ...
  [PluginPermission.FediverseInbound]: Localization.Admin.Plugins.PermissionNames.fediverseInbound,
