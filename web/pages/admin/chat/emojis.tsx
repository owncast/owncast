...
const Emoji = () => {
  ...
  async function handleDelete(fullPath: string) {
    ...
    setSubmitStatus(createInputStatus(STATUS_PROCESSING, t(Localization.Admin.StatusMessages.deletingEmoji)));
    ...
    try {
      ...
      setSubmitStatus(createInputStatus(STATUS_SUCCESS, t(Localization.Admin.StatusMessages.emojiDeleted)));
  ...
  async function handleEmojiUpload() {
    setLoading(true);
    try {
      setSubmitStatus(createInputStatus(STATUS_PROCESSING, t(Localization.Admin.StatusMessages.convertingEmoji)));
      ...
      setSubmitStatus(createInputStatus(STATUS_PROCESSING, t(Localization.Admin.StatusMessages.uploadingEmoji)));
      ...
      setSubmitStatus(createInputStatus(STATUS_SUCCESS, t(Localization.Admin.StatusMessages.emojiUploadedSuccessfully)));
      getEmojis();
    } catch (error) {
      setSubmitStatus(createInputStatus(STATUS_ERROR, `${error}`));
    }
