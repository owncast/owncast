...
export const SOCKET_MESSAGE_TYPES = {
  ...
  FEDIVERISE_BOOST: 'FEDIVERISE_BOOST',
  FEDIVERISE_FAV: 'FEDIVERISE_FAV',
  FEDIVERISE_FOLLOW: 'FEDIVERISE_FOLLOW',
};

export const FEDIVERSE_MESSAGE_TYPES = [
  SOCKET_MESSAGE_TYPES.FEDIVERISE_BOOST,
  SOCKET_MESSAGE_TYPES.FEDIVERISE_FAV,
  SOCKET_MESSAGE_TYPES.FEDIVERISE_FOLLOW,
];
