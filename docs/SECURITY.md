...
To report a security issue with Owncast, [open an issue](https://github.com/owncast/owncast/issues/new) on the Owncast GitHub repository and _do not_ mention vulnerability details in the issue. If you have a preferred next step on where to discuss the details of the disclosure, please mention that in the issue if it's appropriate for those details to be public.
