...
func (c *Controllers) NodeInfoV2Controller(w http.ResponseWriter, r *http.Request) {
	...
	localPostCount, _ := c.persistence.GetLocalPostCount()
...
func (c *Controllers) XNodeInfo2Controller(w http.ResponseWriter, r *http.Request) {
...
func (c *Controllers) InstanceV1Controller(w http.ResponseWriter, r *http.Request) {
	type Stats struct {
