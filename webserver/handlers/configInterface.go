...
func (s *ServerInterfaceImpl) SetFederationEnableQuotes(w http.ResponseWriter, r *http.Request) {
	s.h.middleware.RequireAdminAuth(s.h.admin.SetFederationEnableQuotes)(w, r)
}

func (s *ServerInterfaceImpl) SetFederationEnableQuotesOptions(w http.ResponseWriter, r *http.Request) {
	s.h.middleware.RequireAdminAuth(s.h.admin.SetFederationEnableQuotes)(w, r)
}
