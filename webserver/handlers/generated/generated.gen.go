...
type ServerInterface interface {
	// GetExternalAPIUsers Get all access tokens
	...
	// CreateExternalAPIUser Create a single access token
	...
	// DeleteExternalAPIUser Delete a single external API user
	// (POST /admin/accesstokens/delete)
	DeleteExternalAPIUser(w http.ResponseWriter, r *http.Request)
	// GetConnectedChatClients Get a detailed list of currently connected chat clients
	...
	// GetChatMessagesAdmin Get all chat messages for the admin, unfiltered
	...
	// UpdateMessageVisibilityAdmin Update visibility of chat messages
	// (POST /admin/chat/messagevisibility)
	UpdateMessageVisibilityAdmin(w http.ResponseWriter, r *http.Request)
	// GetDisabledUsers Get a list of disabled users
	...
	// GetIPAddressBans Get all banned IP addresses
	...
	// BanIPAddress Ban an IP address
	...
	// UpdateUserEnabledAdmin Enable or disable a user
	...
	// SetAdminPassword Change the current admin password
	...
	// SetCustomColorVariableValues Set style/color/css values
	...
	// SetAutoplay Update autoplay behavior
	...
	// SetEnableEstablishedChatUserMode Enable/disable chat established user mode
	...
	// SetForbiddenUsernameList Set chat usernames that are not allowed
	...
	// SetChatJoinMessagesEnabled Enable chat for user join messages
	...
	// SetChatRequireAuthentication Set require authentication for chat
	...
	// SetChatSlurFilterEnabled Set slur filter enabled
	...
	// SetChatSpamProtectionEnabled Set spam protection enabled
	...
	// SetSuggestedUsernameList Set the suggested chat usernames that will be assigned automatically
	...
	// SetCustomJavascript Update custom JavaScript
	...
	// SetCustomStyles Update custom styles
	...
	// SetDirectoryEnabled Update directory enabled
	...
	// SetDisableSearchIndexing Update search indexing
	...
	// SetFavicon Upload custom favicon
	...
	// SetFederationBlockDomains Set Federation blocked domains
	...
	// SetFederationEnabled Enable/disable federation features
	...
	// SetFederationEnableQuotes Set if posts from this server can be quoted
	...
	// SetFederationHideFollowersTab Set if the public followers tab is hidden on the web UI
	...
	// SetFederationGoLiveMessage Set federated go live message
	...
	// SetFederationActivityPrivate Set if federation activities are private
	...
	// SetFederationShowEngagement Set if fediverse engagement appears in chat
	...
	// SetFederationUsername Set local federated username
	...
	// SetFfmpegPath Update FFMPEG path
	...
	// SetHideViewerCount Update hide viewer count
	...
	// SetServerName Change the server name
	...
	// SetBrowserNotificationConfiguration Configure Browser notifications
	...
	// SetDiscordNotificationConfiguration Configure Discord notifications
	...
	// SetCustomOfflineMessage Change the offline message
	...
	// SetRTMPServerBindAddress Update RTMP server bind address
	...
	// SetRTMPServerPort Update RTMP post
	...
	// SetS3Configuration Update S3 configuration
	...
	// SetServerSummary Change the server summary
	...
	// SetServerURL Update server url
	...
	// SetSocialHandles Update social handles
	...
	// SetSocketHostOverride Update websocket host override
	...
	// SetStreamKeys Set an array of valid stream keys
	...
	// SetStreamTitle Change the stream title
	...
	// SetStreamLatencyLevel Set the number of video segments and duration per segment in a playlist
	...
	// SetStreamOutputVariants Set an array of video output configurations
	...
	// SetVideoServingEndpoint Update custom video serving endpoint
	...
	// SetWebServerIP Update server IP address
	...
	// SetWebServerPort Update server port
	...
	// GetFederatedActions Get a paginated list of federated activities
	...
	// GetFeatureRequests Get pending requests from other servers to feature this server's stream
	...
	// SendFederatedMessage Send a public message to the Fediverse from the server's user
	// (POST /admin/federation/send)
	SendFederatedMessage(w http.ResponseWriter, r *http.Request)
	// GetAdminFederatedServers Get all federated servers (admin), including pending requests
	...
	// AddFederatedServer Add a federated server to follow
	// (POST /admin/federation/servers)
	AddFederatedServer(w http.ResponseWriter, r *http.Request)
	// RemoveFederatedServer Remove a federated server
	...
	// ApproveFollower Set the following state of a follower or follow request
	// (POST /admin/followers/approve)
	ApproveFollower(w http.ResponseWriter, r *http.Request)
	// GetBlockedAndRejectedFollowers Get a list of rejected or blocked follows
	...
	// GetDirectoryFollowers Get directories that are featuring/listing this server
	...
	// GetPendingFollowRequests Get a list of pending follow requests
	...
	// RemoveFollower Remove a follower without blocking them (they may follow again)
	// (POST /admin/followers/remove)
	RemoveFollower(w http.ResponseWriter, r *http.Request)
	// GetHardwareStats Get the current hardware stats
	...
	// GetWarnings Get warning/error logs
	...
	// GetVideoPlaybackMetrics Get video playback metrics
	...
	// GetAdminSchedule Get every scheduled event and recurring series for the admin
	// (GET /admin/schedule)
	...
	// UpsertScheduledEvent Create or update a scheduled event or recurring series
	...
	// DeleteScheduledEvent Delete or cancel a scheduled event or recurring series
	...
	// PreviewScheduleRecurrence Preview the occurrences a recurrence rule would produce
	...
	// StatusAdmin Get current inboard broadcaster
	// (GET /admin/status)
	...
	// (OPTIONS /admin/users)
	GetUsersOptions(w http.ResponseWriter, r *http.Request)

	// (OPTIONS /admin/users/delete)
	DeleteUserOptions(w http.ResponseWriter, r *http.Request)
	// DeleteUser Permanently delete a user and all of their data
	// (POST /admin/users/delete)
	DeleteUser(w http.ResponseWriter, r *http.Request)
	// GetActiveViewers Get active viewers
	// (GET /admin/viewers)
	...
	// GetPlaybackClients Get the playback clients of active viewers with their current playback health
	// (GET /admin/viewers/playback)
	GetPlaybackClients(w http.ResponseWriter, r *http.Request)

	// (OPTIONS /admin/viewers/playback)
	GetPlaybackClientsOptions(w http.ResponseWriter, r *http.Request)
	// GetViewersOverTime Get viewer count over time
	...
	// GetWebhooks Get all the webhooks
	// (GET /admin/webhooks)
	...
	// CreateWebhook Create a single webhook
	...
	// VerifyFediverseOTPRequest Verify Fediverse OTP code
	// (POST /auth/fediverse/verify)
	VerifyFediverseOTPRequest(w http.ResponseWriter, r *http.Request)
	// StartIndieAuthFlow Begins auth flow
	// (POST /auth/indieauth)
	StartIndieAuthFlow(w http.ResponseWriter, r *http.Request, params StartIndieAuthFlowParams)
	// HandleIndieAuthRedirect Handle the redirect from an IndieAuth server to continue the auth flow
	...
	// HandleIndieAuthEndpointGet Handles the IndieAuth auth endpoint
	...
	// HandleIndieAuthEndpointPost Handles IndieAuth from form submission
	...
	// UpdateMessageVisibility Update chat message visibility
	...
	// RegisterAnonymousChatUser Registers an anonymous chat user
	// (POST /chat/register)
	...
	// SendChatAction Send a user action to chat
	...
	// ExternalUpdateMessageVisibility Hide chat message
	...
	// SendIntegrationChatMessage Send a message to chat as a specific 3rd party bot/integration based on its access token
	...
	// SendSystemMessage Send a system message to the chat
	...
	// SendSystemMessageToConnectedClient Send a system message to a single client
	...
	// SendUserMessage Send a user message to chat
	// (POST /integrations/chat/user)
	//
	// Deprecated: this operation has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	SendUserMessage(w http.ResponseWriter, r *http.Request)
	// ExternalGetConnectedChatClients Connected clients
	...
	// ExternalSetStreamTitle Stream title
	// (POST /integrations/streamtitle)
	ExternalSetStreamTitle(w http.ResponseWriter, r *http.Request)
	// ReportCmcdQuery CMCD collector accepting a report as a query parameter
	// (GET /metrics/cmcd)
	...
	// ReportCmcd CMCD collector accepting event and response mode playback reports
	// (POST /metrics/cmcd)
	ReportCmcd(w http.ResponseWriter, r *http.Request)
	// ReportPlaybackMetrics Save video playback metrics for future video health recording
	...
	// RegisterForLiveNotifications Register for notifications
	...
	// GetSchedule Get the public schedule of upcoming and recent stream events
	// (GET /schedule)
	...
	// GetVideoStreamOutputVariants Get a list of video variants available
	// (GET /video/variants)
	GetVideoStreamOutputVariants(w http.ResponseWriter, r *http.Request)
	// GetYPResponse Get the YP protocol data
	// (GET /yp)
...
// (OPTIONS /admin/users)
func (_ Unimplemented) GetUsersOptions(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// (OPTIONS /admin/users/delete)
func (_ Unimplemented) DeleteUserOptions(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// GetPlaybackClients Get the playback clients of active viewers with their current playback health
// (GET /admin/viewers/playback)
func (_ Unimplemented) GetPlaybackClients(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// (OPTIONS /admin/viewers/playback)
func (_ Unimplemented) GetPlaybackClientsOptions(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// GetPlaybackClients operation middleware
func (siw *ServerInterfaceWrapper) GetPlaybackClients(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetPlaybackClients(w, r)
	}))
...
// GetPlaybackClientsOptions operation middleware
func (siw *ServerInterfaceWrapper) GetPlaybackClientsOptions(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetPlaybackClientsOptions(w, r)
	}))
...
func (siw *ServerInterfaceWrapper) SendSystemMessageToConnectedClientOptions(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "clientId", chi.URLParam(r, "clientId"), &clientId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/admin/viewers/playback", wrapper.GetPlaybackClients)
	})
	r.Group(func(r chi.Router) {
		r.Options(options.BaseURL+"/admin/viewers/playback", wrapper.GetPlaybackClientsOptions)
	})
	r.Group(func(r chi.Router) {
	...
	r.Group(func(r chi.Router) {
		r.Options(options.BaseURL+"/admin/users", wrapper.GetUsersOptions)
	})
	r.Group(func(r chi.Router) {
		r.Options(options.BaseURL+"/admin/users/delete", wrapper.DeleteUserOptions)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/admin/users/delete", wrapper.DeleteUser)
	})
	r.Group(func(r chi.Router) {
