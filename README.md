...
> Note: Currently Owncast only supports Linux based Operating Systems, but Windows Users can use Windows Subsystem for Linux (WSL2) to install Owncast locally. For more details you can check out this [Owncast-for-windows](https://github.com/owncast/owncast/blob/develop/owncast_for_windows.md)
